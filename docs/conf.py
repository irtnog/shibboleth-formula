...
__author__     = 'Matthew X. Economou'      # noqa: E221
__copyright__  = 'Copyright (c) 2015, Matthew X. Economou <xenophon@irtnog.org>' # noqa: E221
__license__    = 'Apache-2.0'               # noqa: E221
__version__    = 'latest'                   # noqa: E221
__maintainer__ = 'Matthew X. Economou'      # noqa: E221


# -- Project information -----------------------------------------------------

project = 'shibboleth-formula'
...
htmlhelp_basename = 'shibboleth-formula'
...
latex_documents = [
    (
        'index',
        'shibboleth-formula.tex',
        u'shibboleth-formula Documentation',
        u'',
        'manual',
    ),
]
